...
try {
    ...
    if(filter_has_var(INPUT_GET, 'term')){
        ...
        $sql = "SELECT genres.GENRE, COUNT(*) FROM books "
        ...
        if($num_rows > 1){
            ...
            echo '<h4>Genres</h4><div class="column_list">';
            
            while($row = mysqli_fetch_assoc($result)){
                echo '<label class="pointer"><input type="checkbox"/>'.$row['GENRE'].'</label><br/>';
            }
